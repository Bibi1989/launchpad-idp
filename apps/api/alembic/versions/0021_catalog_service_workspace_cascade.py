...
Revision ID: 0021_catalog_service_workspace_cascade
...
revision: str = "0021_catalog_service_workspace_cascade"
...
def upgrade() -> None:
    ...
    if workspace_fk:
        op.drop_constraint(workspace_fk, "catalog_services", type_="foreignkey")
