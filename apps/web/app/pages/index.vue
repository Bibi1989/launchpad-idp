...
const stats = computed(() => [
  {
    key: "clouds",
    value: t("landing.stats.clouds.value"),
    label: t("landing.stats.clouds.label"),
  },
  {
    key: "engines",
    value: t("landing.stats.engines.value"),
    label: t("landing.stats.engines.label"),
  },
  {
    key: "runtime",
    value: t("landing.stats.runtime.value"),
    label: t("landing.stats.runtime.label"),
  },
  {
    key: "gitops",
    value: t("landing.stats.gitops.value"),
    label: t("landing.stats.gitops.label"),
  },
]);
...
<template>
  <div
    class="relative min-h-screen overflow-x-hidden bg-[var(--lp-ink)] text-[var(--lp-text)]"
  >
    <div
      ...
      style="
        background:
          ...
          radial-gradient(
            ellipse 45% 35% at 95% 25%,
            rgba(15, 118, 110, 0.16),
            transparent 55%
          ),
          radial-gradient(
            ellipse 35% 30% at 5% 40%,
    ...
    >
      <div
        class="mx-auto flex max-w-6xl items-center justify-between gap-3 px-4 py-3.5 sm:px-6"
      >
    ...
    <main class="relative z-10">
      ...
      <section class="mx-auto max-w-6xl px-6 pb-16 pt-14 md:pb-24 md:pt-20">
        ...
        >
          <div class="max-w-xl space-y-7">
            <p
              class="font-mono text-xs uppercase tracking-[0.28em] text-[var(--lp-accent)]"
            >
              {{ t("landing.eyebrow") }}
            </p>
            <div class="space-y-4">
              <div class="flex items-center gap-4">
                ...
                <h1
                  class="text-5xl font-semibold tracking-tight text-[var(--lp-text)] md:text-6xl md:leading-[1.05]"
                >
                  {{ t("landing.heroTitle") }}
                </h1>
              </div>
              <p
                class="text-2xl font-medium leading-snug tracking-tight text-[var(--lp-text)] md:text-3xl"
              >
                {{ t("landing.heroHeadline") }}
              </p>
            </div>
            <p
              class="text-lg leading-relaxed text-[var(--lp-muted)] md:text-xl"
            >
              {{ t("landing.heroBlurb") }}
            </p>
            ...
            <p
              class="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--lp-muted)]"
            >
              {{ t("landing.heroTrust") }}
            </p>
          </div>
      ...
      <!-- Demo -->
      <!-- <section id="demo" class="mx-auto max-w-6xl px-6 py-20 md:py-28">
        <div class="mx-auto max-w-4xl space-y-4 text-center">
          <p
            class="font-mono text-xs uppercase tracking-[0.22em] text-[var(--lp-accent)]"
          >
            {{ t("landing.demo.eyebrow") }}
          </p>
          <figure
            class="overflow-hidden rounded-2xl border border-[var(--lp-line)] bg-[var(--lp-panel)]"
          >
            <video
              ...
              playsinline
              preload="metadata"
              poster="/videos/launchpad-demo-poster.png"
              :aria-label="t('landing.demo.ariaLabel')"
              autoplay
            >
              <source src="/videos/launchpad-demo.mp4" type="video/mp4" />
            </video>
            <figcaption
              class="border-t border-[var(--lp-line)] px-4 py-2.5 text-xs text-[var(--lp-muted)]"
            >
      ...
      >
        <div class="mx-auto max-w-6xl px-6">
          <p
            class="mb-6 text-center font-mono text-[11px] uppercase tracking-[0.22em] text-[var(--lp-muted)]"
          >
      ...
      <section id="product" class="mx-auto max-w-6xl px-6 py-20 md:py-28">
        <div class="mx-auto max-w-2xl space-y-4 text-center">
          ...
          <p
            class="text-base leading-relaxed text-[var(--lp-muted)] md:text-lg"
          >
      ...
      <!-- How it works -->
      <section
        class="border-y border-[var(--lp-line)] bg-[var(--lp-panel)]/30 py-20 md:py-28"
      >
        <div class="mx-auto max-w-6xl px-6">
          <div class="mx-auto max-w-2xl space-y-4 text-center">
            <p
          ...
          <ol class="mt-14 grid gap-6 md:grid-cols-3 md:gap-8">
            ...
            >
              <p class="font-mono text-sm text-[var(--lp-accent)]">
                {{ step.n }}
              </p>
              <h3 class="mt-3 text-xl font-semibold">{{ step.title }}</h3>
              <p class="mt-3 text-sm leading-relaxed text-[var(--lp-muted)]">
                {{ step.blurb }}
              </p>
            </li>
          </ol>
      ...
      <section id="security" class="mx-auto max-w-6xl px-6 py-20 md:py-28">
        <div class="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
          ...
          <ul class="grid gap-3 sm:grid-cols-2">
            ...
            >
              <span
                class="material-symbols-outlined shrink-0 text-[var(--lp-accent)]"
              >
                verified_user
              </span>
              <span class="text-sm leading-relaxed text-[var(--lp-text)]">{{
                point
              }}</span>
            </li>
          </ul>
      ...
      <!-- Stats -->
      <section
        class="border-y border-[var(--lp-line)] bg-[var(--lp-panel)]/40 py-14"
      >
        <div
          class="mx-auto grid max-w-6xl gap-8 px-6 sm:grid-cols-2 lg:grid-cols-4"
        >
          <div
            v-for="stat in stats"
            :key="stat.key"
          ...
          >
            <p
              class="font-mono text-3xl font-semibold tracking-tight text-[var(--lp-accent)] md:text-4xl"
            >
              {{ stat.value }}
            </p>
    ...
    <footer
      class="relative z-10 border-t border-[var(--lp-line)] bg-[var(--lp-panel)]/50"
    >
      <div
      ...
      >
        ...
        <div>
          <p
            class="font-mono text-[11px] uppercase tracking-[0.2em] text-[var(--lp-muted)]"
          >
            {{ t("landing.footer.product") }}
          </p>
          <ul class="mt-4 space-y-2 text-sm text-[var(--lp-muted)]">
            <li>
              <a href="#product" class="hover:text-[var(--lp-text)]">{{
                t("landing.nav.product")
              }}</a>
            </li>
            <li>
              <a href="#platforms" class="hover:text-[var(--lp-text)]">{{
                t("landing.nav.platforms")
              }}</a>
            </li>
            <li>
              <NuxtLink to="/launch" class="hover:text-[var(--lp-text)]">{{
        ...
        <div>
          ...
          <ul class="mt-4 space-y-2 text-sm text-[var(--lp-muted)]">
            <li>
              <NuxtLink to="/docs" class="hover:text-[var(--lp-text)]">{{
                t("landing.docs")
              }}</NuxtLink>
            </li>
            <li>
        ...
        <div>
          ...
          <ul class="mt-4 space-y-2 text-sm text-[var(--lp-muted)]">
            <li>
              <NuxtLink :to="hubLink.to" class="hover:text-[var(--lp-text)]">{{
                hubLink.label
              }}</NuxtLink>
            </li>
            <li>
              <a href="#security" class="hover:text-[var(--lp-text)]">{{
                t("landing.nav.security")
              }}</a>
            </li>
          </ul>
