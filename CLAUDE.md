...
- Whenever adding, updating, or refactoring endpoints, schemas, DTOs, database models, or services in `apps/api` (FastAPI), you MUST ALSO update the corresponding module in `apps/api-nest` (NestJS) to maintain 1:1 contract and feature parity (and vice-versa).
